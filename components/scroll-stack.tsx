...
const ScrollStack: React.FC<ScrollStackProps> = ({
  ...
  const updateCardTransforms = useCallback(() => {
    ...
    cardsRef.current.forEach((card, i) => {
      ...
      // We use offsetTop to avoid getBoundingClientRect which changes during sticky
      let top = 0;
      ...
      if (blurAmount) {
        ...
        for (let j = 0; j < cardsRef.current.length; j++) {
          let jTop = 0;
          let jEl: HTMLElement | null = cardsRef.current[j];
          while (jEl) {
            jTop += jEl.offsetTop || 0;
            jEl = jEl.offsetParent as HTMLElement;
          }
  ...
  return (
    ...
    >
      <div className="scroll-stack-inner pt-[20vh] px-0 pb-[30rem] min-h-screen">
        {children}
